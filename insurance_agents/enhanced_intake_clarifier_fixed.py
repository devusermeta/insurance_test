...
class EnhancedIntakeClarifier:
    ...
    async def process_claim(self, claim_id: str, session_id: str = None) -> Dict[str, Any]:
        ...
        # Log workflow step
        await workflow_logger.log_step(
            session_id=session_id or f"intake_clarifier_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
            step_type=WorkflowStepType.PROCESSING,
            step_name="enhanced_intake_clarification_started",
        ...
        try:
            ...
            await workflow_logger.log_step(
                ...
                step_name="intake_clarification_completed",
            ...
            await workflow_logger.log_step(
                ...
                step_name="intake_clarification_error",
